...
type ClientRow = { id: string; name: string; email: string | null; phone: string | null; apporteurName: string | null; categories: { id: string; name: string; position: number }[]; totalOwed: number; invoiceCount: number; hasLate: boolean; suspended: boolean }
